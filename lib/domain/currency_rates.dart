...
class CurrencyRates {
  ...
  static List<UnitDef> get units => rates.entries.map((e) => UnitDef(id: e.key, name: names[e.key] ?? e.key, symbol: e.key, strategy: UnitStrategy.factor, factor: 1 / e.value)).toList()..sort((a,b) => a.id.compareTo(b.id));
